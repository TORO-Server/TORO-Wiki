...
2. 成功したら残高見れるよ（例：「1000トロポチャージした！ 残高: 1000トロポ」）。  
3. \*制限\*：
> - 残高は20,000トロポまで。
> - マイナスはNG！
...
2. ICカード持ってコマンド実行。  
3. 購入金額が残高から引かれて、カードに定期券データ書き込み。  
4. \*注意\*：
...
2. トップ10のプレイヤーの移動量（トロポと距離）が見れる。
> - 例：「1位 Steve 1000トロポ 5km」。

3. 自分の順位も出る（トップ10じゃなくても）。  
4. 全ユーザーの合計移動量もチェックできる。  
5. \*計算\*：
> - 1ブロック＝0.2トロポ。
> - 1トロポ＝5mで距離換算。
...
> - 例：http://サーバーIP:5744/api/balance/Steve
> - 返事：{"balance": 1000}
